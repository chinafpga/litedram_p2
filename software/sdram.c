...
// This file is Copyright (c) 2018 Jean-Fran?ois Nguyen <jf@lambdaconcept.fr>
...
static inline void init_sequence_debug(void)
{
	/* Release reset */
...
int sdram_init(void) {
	...
	if(!memtest((unsigned int *) MAIN_RAM_BASE, 16)) {
#ifdef CSR_DDRCTRL_BASE
		printf("f");
