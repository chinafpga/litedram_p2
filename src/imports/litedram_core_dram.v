...
wire   [23:0] main_cmd_payload_addr;
...
reg     [1:0] builder_litedramcore_litedramwishbone2native0_state = 2'd0;
reg     [1:0] builder_litedramcore_litedramwishbone2native0_next_state = 2'd0;
...
reg     [1:0] builder_litedramcore_litedramwishbone2native1_state = 2'd0;
reg     [1:0] builder_litedramcore_litedramwishbone2native1_next_state = 2'd0;
...
assign main_wdata_ready = builder_litedramcore_new_master_wdata_ready3;
assign main_litedramcore_port_rdata_valid = builder_litedramcore_new_master_rdata_valid8;
assign main_rdata_valid = builder_litedramcore_new_master_rdata_valid17;
always @(*) begin
    main_litedramcore_sdram_interface_wdata <= 128'd0;
    case ({builder_litedramcore_new_master_wdata_ready3, builder_litedramcore_new_master_wdata_ready1})
        1'd1: begin
...
always @(*) begin
    builder_litedramcore_litedramwishbone2native0_next_state <= 2'd0;
    builder_litedramcore_litedramwishbone2native0_next_state <= builder_litedramcore_litedramwishbone2native0_state;
    case (builder_litedramcore_litedramwishbone2native0_state)
        1'd1: begin
            if ((main_litedramcore_port_wdata_valid & main_litedramcore_port_wdata_ready)) begin
                builder_litedramcore_litedramwishbone2native0_next_state <= 1'd0;
            end
        end
        2'd2: begin
        ...
        default: begin
            if (((main_litedramcore_port_cmd_valid & main_litedramcore_port_cmd_ready) & main_litedramcore_interface_we)) begin
                builder_litedramcore_litedramwishbone2native0_next_state <= 1'd1;
            end
            if (((main_litedramcore_port_cmd_valid & main_litedramcore_port_cmd_ready) & (~main_litedramcore_interface_we))) begin
                builder_litedramcore_litedramwishbone2native0_next_state <= 2'd2;
            end
        end
    endcase
end
...
always @(*) begin
    builder_litedramcore_litedramwishbone2native1_next_state <= 2'd0;
    builder_litedramcore_litedramwishbone2native1_next_state <= builder_litedramcore_litedramwishbone2native1_state;
    case (builder_litedramcore_litedramwishbone2native1_state)
        1'd1: begin
            if ((main_wdata_valid & main_wdata_ready)) begin
                builder_litedramcore_litedramwishbone2native1_next_state <= 1'd0;
            end
        end
        2'd2: begin
        ...
        default: begin
            if (((main_cmd_valid & main_cmd_ready) & main_wb_port_we)) begin
                builder_litedramcore_litedramwishbone2native1_next_state <= 1'd1;
            end
            if (((main_cmd_valid & main_cmd_ready) & (~main_wb_port_we))) begin
                builder_litedramcore_litedramwishbone2native1_next_state <= 2'd2;
            end
        end
    endcase
end
...
always @(*) begin
    ...
    case (builder_litedramcore_roundrobin0_grant)
        ...
        default: begin
            builder_rhs_array_muxed20 <= {main_cmd_payload_addr[23:10], main_cmd_payload_addr[6:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_litedramcore_roundrobin1_grant)
        ...
        default: begin
            builder_rhs_array_muxed23 <= {main_cmd_payload_addr[23:10], main_cmd_payload_addr[6:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_litedramcore_roundrobin2_grant)
        ...
        default: begin
            builder_rhs_array_muxed26 <= {main_cmd_payload_addr[23:10], main_cmd_payload_addr[6:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_litedramcore_roundrobin3_grant)
        ...
        default: begin
            builder_rhs_array_muxed29 <= {main_cmd_payload_addr[23:10], main_cmd_payload_addr[6:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_litedramcore_roundrobin4_grant)
        ...
        default: begin
            builder_rhs_array_muxed32 <= {main_cmd_payload_addr[23:10], main_cmd_payload_addr[6:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_litedramcore_roundrobin5_grant)
        ...
        default: begin
            builder_rhs_array_muxed35 <= {main_cmd_payload_addr[23:10], main_cmd_payload_addr[6:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_litedramcore_roundrobin6_grant)
        ...
        default: begin
            builder_rhs_array_muxed38 <= {main_cmd_payload_addr[23:10], main_cmd_payload_addr[6:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_litedramcore_roundrobin7_grant)
        ...
        default: begin
            builder_rhs_array_muxed41 <= {main_cmd_payload_addr[23:10], main_cmd_payload_addr[6:0]};
        end
    endcase
end
always @(*) begin
...
always @(posedge sys_clk) begin
    ...
    builder_litedramcore_new_master_rdata_valid14 <= builder_litedramcore_new_master_rdata_valid13;
    ...
    builder_litedramcore_litedramwishbone2native0_state <= builder_litedramcore_litedramwishbone2native0_next_state;
    ...
    builder_litedramcore_litedramwishbone2native1_state <= builder_litedramcore_litedramwishbone2native1_next_state;
    ...
    if (sys_rst) begin
        ...
        builder_litedramcore_litedramwishbone2native0_state <= 2'd0;
        builder_litedramcore_litedramwishbone2native1_state <= 2'd0;
...
//------------------------------------------------------------------------------
// Memory rom: 6465-words x 32-bit
//------------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2023-07-10 15:02:46.
//------------------------------------------------------------------------------
